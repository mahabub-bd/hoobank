    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className='flex flex-1 flex-col justify-start mr-10'>
          <img src={logo} alt="footer__logo" className='w-[266px] h-[72px] object-contain' />
      ...
      <div className='w-full flex justify-between md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]'>
        ...
        <div className='flex flex-row md:mt-0 mt-6'>
          {socialMedia.map((social, index) => (
            ...
            <img key={social.id} src={social.icon} alt={social.name} className={`w-[21px] h-[21px] object-contain cursor-pointer ${index !== social.link.length - 1 ? 'mr-6' : 'mr-0'} hover:opacity-80`}  />
