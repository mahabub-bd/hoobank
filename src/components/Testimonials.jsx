...
const Testimonials = () => {
  return (
    <section id='#clients' className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}>
      <div className='absulate z-[0] w-[60%] h-[60%] -right-[50%] rounded-full blue__gradient' />
      <div className='w-full flex justify-center items-center md:flex-row flex-col sm:md-16 mb-6 relative z-[1]'>
